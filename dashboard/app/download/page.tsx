...
export default function DownloadPage() {
  return (
    <div style={{ background: "#fff", color: "#0f172a", minHeight: "100vh", fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}>
      ...
      {/* ── HERO ── */}
      <section className="responsive-hero-section" style={{ padding: "80px 48px 0", background: "#fff", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1, paddingBottom: 60 }}>
      ...
      <div className="responsive-page-container" style={{ maxWidth: 960, margin: "0 auto", padding: "0 48px 120px" }}>

        {/* ── REQUIREMENTS ── */}
        <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
          style={{ marginBottom: 64 }}>
          <div className="responsive-grid-2col" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16 }}>
        ...
        {releases.map((rel, ri) => (
          <motion.section key={ri} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 + ri * 0.05 }}
            ...
            <div style={{ padding: "28px 32px" }}>
              ...
              <div className="responsive-grid-1col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        ...
        {/* ── NEXT STEP ── */}
        <div className="responsive-flex-stack" style={{ marginTop: 56, padding: "36px 40px", borderRadius: 20, background: "linear-gradient(135deg, #f4f3ff 0%, #ede9fe 100%)", border: `1.5px solid ${VB}`, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 20 }}>
          <div>
